            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  subject: { type: 'string', example: 'API Test' },
                  message: { type: 'string', example: 'Testing the API route.' }
                }
              }
            }
          }
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  courseId: { type: 'string', example: 'python-beginners-live-01' },
                  currency: { type: 'string', example: 'INR' },
                  couponCode: { type: 'string', example: 'BIRTHDAY20' },
                  userId: { type: 'string', example: 'user_2aBcD...' }
                }
              }
            }
          }
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  razorpay_payment_id: { type: 'string', example: 'pay_XYZ987' },
                  razorpay_signature: { type: 'string', example: 'a1b2c3d4e5f6...' },
                  userId: { type: 'string', example: 'user_2aBcD...' },
                  courseSlug: { type: 'string', example: 'python-beginners' },
                  userEmail: { type: 'string', example: 'student@example.com' },
                  userName: { type: 'string', example: 'John Doe' },
                  courseTitle: { type: 'string', example: 'Python Live Session' },
                  amountPaid: { type: 'string', example: '₹599' },
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  courseSlug: { type: 'string', example: 'python-beginners' },
                  currency: { type: 'string', example: 'INR' },
                  couponCode: { type: 'string', example: 'BATCH002' },
                  userId: { type: 'string', example: 'user_2aBcD...' },
                  userName: { type: 'string', example: 'John Doe' },
                  userEmail: { type: 'string', example: 'student@example.com' }
                }
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: {
                  code: { type: 'string', example: 'prnt("Hello")' },
                  assignment: { type: 'string', example: 'Print Hello World' },
                  output: { type: 'string', example: 'NameError: name prnt is not defined' }
                }
              }
            }
          }
