      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
        <SpotlightCard className="md:col-span-2 md:row-span-2 group">
          <div className="flex justify-between items-start mb-8">
            <div className="p-3 bg-gradient-to-br from-amber-500/20 to-amber-600/5 rounded-xl border border-amber-500/20">
            ...
            <span className="text-xs font-bold tracking-widest text-amber-400 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20 shadow-[0_0_15px_rgba(59,130,246,0.2)]">AGENTIC AI</span>
          </div>
        ...
        <SpotlightCard className="md:col-span-1 md:row-span-1 group">
          <h4 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-b from-amber-400 to-amber-600 mb-3 group-hover:from-white group-hover:to-slate-300 transition-all">40%</h4>
        ...
        <SpotlightCard className="md:col-span-1 md:row-span-1 group">
          <h4 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-b from-amber-400 to-amber-600 mb-3 group-hover:from-white group-hover:to-slate-300 transition-all">&gt;85%</h4>
        ...
        <SpotlightCard className="md:col-span-3 md:row-span-1">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <div className="flex -space-x-4 pr-4">
              <div className="w-14 h-14 rounded-full border-2 border-slate-900 bg-gradient-to-br from-amber-500 to-amber-700 shadow-lg flex items-center justify-center animate-pulse"><span className="text-sm font-bold text-white">CI</span></div>
              <div className="w-14 h-14 rounded-full border-2 border-slate-900 bg-gradient-to-br from-amber-400 to-amber-600 shadow-lg flex items-center justify-center animate-pulse delay-75"><span className="text-sm font-bold text-white">CD</span></div>
              <div className="w-14 h-14 rounded-full border-2 border-slate-900 bg-gradient-to-br from-cyan-400 to-amber-500 shadow-lg flex items-center justify-center animate-pulse delay-150"><span className="text-sm font-bold text-white">QA</span></div>
            </div>
          </div>
        </SpotlightCard>
      </div>
